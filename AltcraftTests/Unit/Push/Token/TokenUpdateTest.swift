...
final class TokenUpdateTests: XCTestCase {
    ...
    /// test_1: returns RetryEvent when request data cannot be built
    ...
    /// test_2: emits ErrorEvent and completes when current token is nil
    ...
    /// test_3: sets currentToken and attempts update when tokens differ
    ...
    /// test_4: completes without update when tokens are equal
