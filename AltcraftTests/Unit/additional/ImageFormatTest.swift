...
final class ImageFormatTests: XCTestCase {
    ...
    /// PNG signature detection returns correct format
    ...
    /// JPEG signature detection returns correct format
    ...
    /// GIF signature detection returns correct format
    ...
    /// WEBP signature detection returns correct format
    ...
    /// BMP signature detection returns correct format
    ...
    /// TIFF signatures detection returns correct format for both endianness
    ...
    /// HEIC family signatures detection returns correct format for supported brands
    ...
    /// UTI hints returns correct identifiers for supported formats
    ...
    /// Short data returns nil for insufficient data
    ...
    /// Unknown format returns nil for unrecognized signatures
    ...
    /// Partial signatures returns nil for incomplete data
    ...
    /// File extensions returns correct values for all formats
    ...
    /// Exactly 12 bytes data returns correct format
    ...
    /// WEBP signature with extra data returns correct format
