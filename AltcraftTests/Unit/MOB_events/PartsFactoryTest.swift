...
final class PartsFactoryTests: IsolatedTestCase {
    ...
    /// Factory creates all required text parts with correct values
    ...
    /// Factory correctly handles optional fields
    ...
    /// Time conversion correctly handles both milliseconds and seconds
    ...
    /// Factory correctly processes UTM data from binary JSON
    ...
    /// Factory creates JSON parts only when corresponding data exists
    ...
    /// epochSeconds correctly converts milliseconds to seconds
    ...
    /// epochSeconds leaves seconds values as-is
    ...
    /// Tests boundary cases for time conversion logic
