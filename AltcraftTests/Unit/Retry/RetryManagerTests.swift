 ...
 *
 * Positive scenarios:
 *  - test_1: store → replaces existing task and cancels old.
 *  - test_2: cancelAll → cancels pending tasks across all queues.
 *  - test_3: queues execute scheduled tasks independently.
 *  - test_4: store is thread safe and last task runs.
 */
